        ...
        <div className="flex justify-center">
            ...
            <img src="/icon/Solid/PNG/save_.png" alt=""  className="w-[100px] h-auto object-cover rounded-xl"/>
                ...
                <div className="relative flex flex-col  ">
                    ...
                    <div className="w-[200px] absolute h-[65%] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#2e939a] z-0" />


                    <div className="relative group inline-block w-full pt-32" id='yu'>
                    ...
                    <div className="relative group inline-block w-full pt-32 mb-24" id='seangta'>
